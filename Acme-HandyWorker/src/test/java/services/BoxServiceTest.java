...
public class BoxServiceTest extends AbstractTest {
	...
	public void testFindInBoxByActor() {
		...
		Assert.isTrue(inBox.getName() == "in box" && inBox.getByDefault());
	...
	public void testFindOutBoxByActor() {
		...
		Assert.isTrue(inBox.getName() == "out box" && inBox.getByDefault());
	...
	public void testFindTrashBoxByActor() {
		...
		Assert.isTrue(inBox.getName() == "trash box" && inBox.getByDefault());
	...
	public void testFindSpamBoxByActor() {
		...
		Assert.isTrue(inBox.getName() == "spam box" && inBox.getByDefault());
	...
	private void createNewActorAndLogIn() {
		...
		customer.setEmail("identifier@domain.com");
		customer.setPhone("");
