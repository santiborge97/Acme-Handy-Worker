...
public class WarrantyService {
	...
	public Warranty save(final Warranty warranty) {
		...
		if (warranty.getId() != 0) {
			...
			final Warranty test = this.warrantyRepository.findOne(warranty.getId());
			Assert.isTrue(test.getFinalMode() == false);
	...
	public Collection<Warranty> findWarrantiesFinalMode() {
		Collection<Warranty> finalWarranties;

		finalWarranties = this.warrantyRepository.findWarrantiesFinalMode();

		return finalWarranties;
	}
